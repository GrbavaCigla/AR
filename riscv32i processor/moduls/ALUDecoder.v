...
assign	GDFX_TEMP_SIGNAL_10 = 4'b1010;
assign	GDFX_TEMP_SIGNAL_17 = 4'b0111;
assign	GDFX_TEMP_SIGNAL_13 = 4'b0110;
assign	GDFX_TEMP_SIGNAL_15 = 4'b0101;
assign	GDFX_TEMP_SIGNAL_9  = 4'b0100;
assign	GDFX_TEMP_SIGNAL_7  = 4'b0011;
assign	GDFX_TEMP_SIGNAL_5  = 4'b0010;
assign	GDFX_TEMP_SIGNAL_3  = 4'b0001;
assign	GDFX_TEMP_SIGNAL_1  = 4'b0000;
assign	GDFX_TEMP_SIGNAL_11 = 4'b0000;
assign	GDFX_TEMP_SIGNAL_0  = {1'b0, funct3[2:0]};
assign	GDFX_TEMP_SIGNAL_2  = {1'b0, funct3[2:0]};
assign	GDFX_TEMP_SIGNAL_4  = {1'b0, funct3[2:0]};
assign	GDFX_TEMP_SIGNAL_6  = {1'b0, funct3[2:0]};
assign	GDFX_TEMP_SIGNAL_8  = {1'b0, funct3[2:0]};
assign	GDFX_TEMP_SIGNAL_12 = {1'b0, funct3[2:0]};
assign	GDFX_TEMP_SIGNAL_14 = {1'b0, funct3[2:0]};
assign	GDFX_TEMP_SIGNAL_16 = {1'b0, funct3[2:0]};
...
assign	ALUControl_arith[0] = sel_SUB | sel_SLL | sel_OR | sel_SRA | sel_SLTU;
...
assign	ALUControl_branch[2] = 1'b0;
assign	ALUControl_branch[1] = 1'b0;

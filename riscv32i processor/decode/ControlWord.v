...
// CREATED		"Sun Aug 09 23:23:34 2026"
...
assign	ALUSrc = is_Itype | is_SW | is_LW | is_JALR | is_LUI | is_AUIPC;

assign	ALUOp_ALTERA_SYNTHESIZED[1] = is_Rtype | is_Itype;

assign	ALUOp_ALTERA_SYNTHESIZED[0] = is_Branch & 1;
